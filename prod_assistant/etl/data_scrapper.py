...
class ProductDataScraper:
    """Scrapes product data and reviews from e-commerce websites.
    """
    def __init__(self, output_dir='data'):
        """Initializes the web scraper with necessary configurations.
        """
    ...
    def get_top_reviews(self, product_url, count=2):
        """
        Fetches the top reviews for a given product URL.
        Args:
            product_url (str): The URL of the product page.
            count (int): The number of top reviews to fetch.
        Returns:
            str: A string containing the top reviews separated by " || ", or "No reviews found" if none are available.
        """
    ...
    def scrape_product_data(self, query, max_products=1, review_count=2):
        """Scrape products based on a search query.
        """
        options = uc.ChromeOptions()
        driver = uc.Chrome(options=options,use_subprocess=True)
