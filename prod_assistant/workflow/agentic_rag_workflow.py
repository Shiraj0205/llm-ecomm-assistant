...
if __name__ == "__main__":
    ...
    # Retrieval workflow test, LLM uses retrieved context to answer
    answer = rag_agent.run("What is the price of iPhone 16?")

    # No retrieval workflow test, LLM generates direct answer
    #answer = rag_agent.run("What is capital of USA?")
