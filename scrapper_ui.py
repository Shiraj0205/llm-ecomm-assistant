...
from prod_assistant.etl.data_scrapper import ProductDataScraper
from prod_assistant.etl.data_ingestion import DataIngestion
import os

product_scraper = ProductDataScraper()
...
if st.button("🚀 Start Scraping"):
    ...
    if not product_inputs:
        ...
        for query in product_inputs:
            ...
            results = product_scraper.scrape_product_data(query, max_products = max_products, review_count = review_count)
        ...
        product_scraper.save_to_csv(final_data, output_path)
